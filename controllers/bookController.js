...
exports.book_create_post = [
  ...
  (req, res, next) => {
    ...
    //  Errors, rerender form with error msgs
    if (!errors.isEmpty()) {
...
exports.book_update_post = [
  ...
  (req, res, next) => {
    ...
    const book = new Book({
      ...
      _id: req.params.id, //  if you don't do this it will replace id with new one
    });
    //  error stuff
    if (!errors.isEmpty()) {
      //  rerender form
    ...
    //  form data valid update database
